using System.Net;
using Functions4870.Models.School;
...
namespace Students.Function
{
    public class StudentsWebAPI
    {
        private readonly ILogger<StudentsWebAPI> _logger;
        private readonly SchoolContext _context;

        public StudentsWebAPI(ILogger<StudentsWebAPI> logger, SchoolContext context)
        {
            _logger = logger;
            _context = context;
        }

        [Function("StudentsWebAPI")]
